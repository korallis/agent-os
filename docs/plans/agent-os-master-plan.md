...
├── .github/workflows/
│   ├── ci.yml                        # typecheck/lint/build/test + phase-1…6/6-wizard/6-fidelity/6-terminal/7/8 gates
...
└── tooling/
    ├── gates/                        # phase-{1,2,2b,3,4,5,6,6-terminal,7,8}.mjs + phase-6-wizard / phase-6-fidelity + lib/ports.mjs (Chromium-safe pickPort)
    │                                 #   (2b: Phase 2 fixture completion; phase-6/8: Playwright + real daemon where noted; phase-6-terminal: PTY seq soak + reconnect; phase-7: secondmates)
