...
├── .github/workflows/
│   ├── ci.yml                        # typecheck/lint/build/test + phase-1…6/6-wizard/6-fidelity/7/8 gates
...
└── tooling/
    ├── gates/                        # phase-{1,2,2b,3,4,5,6,7,8}.mjs + phase-6-wizard / phase-6-fidelity + lib/ports.mjs (Chromium-safe pickPort)
